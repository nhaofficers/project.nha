...
const categories = [
  { title: 'সমাপ্ত প্রকল্প', count: '৩৫', detail: 'সমাপ্ত ও হস্তান্তরকৃত প্রকল্পের পূর্ণ তালিকা', href: '/public/completed-projects', tone: 'completed', share: '৪৯%' },
  { title: 'চলমান প্রকল্প', count: '১৮', detail: 'বর্তমানে বাস্তবায়নাধীন প্রকল্পের যাচাইকৃত তালিকা', href: '/public/ongoing-projects', tone: 'ongoing', share: '২৫%' },
  { title: 'ভবিষ্যৎ প্রকল্প', count: '১৮', detail: 'নিকটমেয়াদি ও দীর্ঘমেয়াদি পরিকল্পনার পূর্ণ তালিকা', href: '/public/future-projects', tone: 'future', share: '২৫%' },
] as const;

const projectTypes = [
  { title: 'প্লটভিত্তিক প্রকল্প', count: '৩০', completed: '২২', ongoing: '৬', future: '২', units: '৫,০৯০', unitLabel: 'সমাপ্ত প্রকল্পে প্লট', href: '/public/plot-projects', tone: 'plot' },
  { title: 'ফ্ল্যাটভিত্তিক প্রকল্প', count: '২৮', completed: '১২', ongoing: '৮', future: '৮', units: '২,৪৫৯', unitLabel: 'সমাপ্ত প্রকল্পে ফ্ল্যাট', href: '/public/flat-projects', tone: 'flat' },
] as const;
...
export default function PublicHome() {
  ...
  return <PublicShell><main className="dashboard-landing">
    <section className="infographic-dashboard" id="project-dashboard"><div className="public-wrap">
      <div className="dashboard-heading"><div><span>প্রকল্পসমূহের বাস্তব চিত্র</span><h1>প্রকল্প ড্যাশবোর্ড</h1><p>প্রকল্পের অবস্থা নির্বাচন করে বিস্তারিত তথ্য ও অনুমোদিত আলোকচিত্র দেখুন।</p></div><div className="dashboard-total" aria-label="মোট ৭১টি তালিকাভুক্ত প্রকল্প"><strong>৭১</strong><span>সমন্বিত তালিকাভুক্ত<br/>প্রকল্প</span></div></div>
      ...
      <div className="dashboard-footnote"><span>তথ্য হালনাগাদ</span><p>সমাপ্ত ও চলমান প্রকল্প জাতীয় গৃহায়ন কর্তৃপক্ষের প্রকাশিত তালিকা এবং ভবিষ্যৎ প্রকল্প প্রদত্ত সমন্বিত নথির ভিত্তিতে উপস্থাপিত।</p></div>
    </div></section>
